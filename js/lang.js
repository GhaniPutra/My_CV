const translations = {
  en: {
    ...
    hero_btn_view_cv: "View CV",
    hero_btn_projects: "View Projects",
    cv_modal_title: "Curriculum Vitae",
    cv_modal_open_tab: "Open in Tab",
    cv_modal_fallback: "Can't display PDF directly in your browser?",
    cv_modal_fallback_link: "Click here to view in a new tab",
    ...
    proj1_btn: "Live Demo",
    proj2_desc: "A Flutter-based GPS tracking application integrated with a backend for real-time location tracking, device management, and geofencing.",
    proj2_btn: "View Code",
    proj3_desc: "A lightweight, modern weather application built with Flutter. It displays real-time weather info based on GPS or city name with a persistent favorites list.",
    proj3_btn: "Download APK",
    contact_bg: "CONTACT",
  ...
  id: {
    ...
    hero_btn_view_cv: "Lihat CV",
    hero_btn_projects: "Lihat Proyek",
    cv_modal_title: "Curriculum Vitae",
    cv_modal_open_tab: "Buka di Tab",
    cv_modal_fallback: "Tidak dapat menampilkan pratinjau PDF langsung?",
    cv_modal_fallback_link: "Klik di sini untuk melihat di tab baru",
    ...
    proj2_desc: "Aplikasi pelacak GPS berbasis Flutter dengan integrasi backend untuk pelacakan lokasi secara real-time, manajemen perangkat, dan geofence.",
    proj2_btn: "Lihat Kode",
    proj3_desc: "Aplikasi cuaca ringan dan modern yang dibangun dengan Flutter. Menampilkan informasi cuaca real-time berdasarkan lokasi GPS atau nama kota, dengan fitur favorit persisten.",
    proj3_btn: "Unduh APK",
    contact_bg: "KONTAK",
